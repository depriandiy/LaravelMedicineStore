...
Purchase: http://themeforest.net/item/{{ asset('') }}conquer-responsive-admin-dashboard-template/3716838?ref=keenthemes
...
<head>
<meta charset="utf-8"/>
<title>My Store | Admin Dashboard</title>
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li>
					<a href="/medicines">
					<i class="icon-home"></i>
					<span class="title">Master Medicine</span>
					<span class="selected"></span>
					</a>
				</li>
				<li >
					...
					<ul class="sub-menu">
						{{-- <li>
							...
							Number of Categories that have data Medicines</a>
						</li> --}}
						<li>
							<a href="listcatnomed">
							<i class="icon-book-open"></i>
							Categories that doesn't have any data Medicines</a>
						</li>
						<li>
							<a href="avgprice">
							<i class="icon-pin"></i>
							Average price of each drugs Categories</a>
						</li>
						<li>
							<a href="onemedicine">
							<i class="icon-vector"></i>
                            Categories that have only 1 Medicines product</a>
						</li>
						<li>
							<a href="drugoneform">
							<i class="icon-cursor"></i>
							Drugs that have one form</a>
						</li>
						<li>
							<a href="highestprice">
							<i class="icon-rocket"></i>
							Category and name of Drugs that has the highest price</a>
                            {{-- LANJUTIN MASTER REPORT --}}
						</li>
					</ul>
				</li>
				{{-- <li class="last ">
